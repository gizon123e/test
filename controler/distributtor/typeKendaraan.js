...
module.exports = {
    ...
    createTypeKendaraan: async (req, res, next) => {
        try {
            ...
            const data = await TypeKendaraan.create({ nama, jenisKendaraan, merk_kendaraan: merk })
    ...
    updateTypeKendaraan: async (req, res, next) => {
        try {
            ...
            const data = await TypeKendaraan.findByIdAndUpdate({ _id: req.params.id }, { nama, jenisKendaraan, merk_kendaraan: merk }, { new: true })
