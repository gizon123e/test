...
module.exports = {
    ...
    createPencarianUlangDistributor: async (req, res, next) => {
        try {
            ...
            await Pengiriman.updateMany({ orderId, id_toko, kode_pengiriman }, { distributorId, status_distributor: "Pesanan terbaru", rejected: false, status_pengiriman: 'diproses', id_jenis_kendaraan, id_jenis_layanan, potongan_ongkir })
